    ...
    while True:
        try:
            ...
            if inputlogin == "A" or inputlogin == "a":
                ...
                userchoose()
        except:print("Invalid data entered!")
...
def edithallinfo():
    ...
    edithallid = str(input("Enter the Hall ID of the Hall you want to edit: "))
    flag = False
    with open("hallinfo.txt", "r") as f:
            fulldata = f.read().split("\n")
            for count in range(0, len(fulldata)-1):
...
def editbookinginfo():
    ...
    if flag == True:
        ...
        eventhallid = str(input("Enter the Hall ID to host the event: "))
        flag = False
        while flag == False:
            with open("hallinfo.txt", 'r') as f:
                    data = f.read().split("\n")
...
def cancelbooking():
    ...
    delbookingid = str(input("Enter the Booking ID of the booking you want to cancel: "))
    flag = False
    with open("booking.txt", "r") as f:
            fulldata = f.read().split("\n")
            for count in range(0, len(fulldata)-1):
...
def editbooking():
    ...
    delbookingid = str(input("Enter the Booking ID of the booking you want to edit: "))
    flag = False
    with open("booking.txt", "r") as f:
            fulldata = f.read().split("\n")
            for count in range(0, len(fulldata)-1):
    ...
    if flag == True:
        ...
        while flag == True:
            ...
            if flag == False:
                ...
                eventdate = input("Enter date of the booking in the format DD/MM/YY: ")
                while len(eventdate) != 8 or int(eventdate.split("/")[0])>31 or int(eventdate.split("/")[1])>12 or int(eventdate.split("/")[2])<24:
                    print("\nInvalid Date entered!\n")
                    eventdate = input("Enter date of the booking in the format DD/MM/YY: ")
